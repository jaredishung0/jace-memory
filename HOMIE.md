...
| Public safety ops, commissioning | Agent network, execution |
| Artistic direction, client vision | Implementation, shipping, maintenance |

**The lock:** Jared shapes vision — space, ecology, community, client. I execute — systems, code, agents, business. Neither could do what the other does.
